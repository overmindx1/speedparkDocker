...
@section('dataContainer')
    ...
    <div class="panel panel-default dataContainer">
        ...
        <div class="panel-heading">
            ...
            |<button type="button" class="btn btn-info btn-xs" @click="showAllDetailTrigger()">全部展開/收起</button>
        </div>
    ...
    <template id="orderList">
        <div>
            <div class="panel panel-primary" v-for="order in orderList">
                <div class="panel-heading">
                    <h3 class="panel-title">訂單列表:#{{order.id}} | <button type="button" class="btn btn-info btn-xs" @click="triggerDetail(order.id)">展開/收起</button> </h3>
                </div>
                <div class="panel-body searchDetail" v-show="order.showDetail">
                ...
                getOrderList : function(page)  {
                    ...
                    this.$http.get(url).then(function (reponse) {
                        ...
                        for(var o in orderList.orderList) {
                                ...
                                orderList.orderList[o].addressDetail = this.formatAddress(orderList.orderList[o]);
